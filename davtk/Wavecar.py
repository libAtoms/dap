...
class Wavecar:
    ...
    def __init__(self, filename='WAVECAR', verbose=False, precision='normal', gamma=None):
        ...
        with open(self.filename, 'rb') as f:
            ...
            if rtag != 45200 and rtag != 45210 and rtag != 53300 and rtag != 53310:
                ...
                # reader below assumed that record boundaries can be ignored
    ...
    def fft_mesh(self, kpoint, band, spin=0, shift=True):
        ...
        for gp, coeff in zip(self.Gpoints[kpoint], tcoeffs):
            ...
            # I have no idea where this factor of sqrt(2) comes from, but
            # empirically it appears to be necessary
            mesh[t] = coeff if not self.gamma or all(gp.astype(int) == (0,0,0)) else coeff/np.sqrt(2)
        if shift:
